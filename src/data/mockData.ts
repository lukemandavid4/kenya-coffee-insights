...
export const countyWeatherData: Record<string, { month: string; rainfall: number; temp: number; humidity: number }[]> = {
  Nyeri: [
    { month: "Jan", rainfall: 38, temp: 19.2, humidity: 68 },
    { month: "Feb", rainfall: 32, temp: 19.8, humidity: 63 },
    { month: "Mar", rainfall: 130, temp: 19.5, humidity: 75 },
    { month: "Apr", rainfall: 310, temp: 18.2, humidity: 85 },
    { month: "May", rainfall: 200, temp: 17.5, humidity: 80 },
    { month: "Jun", rainfall: 35, temp: 16.8, humidity: 64 },
    { month: "Jul", rainfall: 22, temp: 16.0, humidity: 60 },
    { month: "Aug", rainfall: 28, temp: 16.5, humidity: 62 },
    { month: "Sep", rainfall: 40, temp: 17.8, humidity: 65 },
    { month: "Oct", rainfall: 160, temp: 18.5, humidity: 78 },
    { month: "Nov", rainfall: 240, temp: 18.9, humidity: 82 },
    { month: "Dec", rainfall: 100, temp: 19.0, humidity: 72 },
  ],
  Kirinyaga: [
    { month: "Jan", rainfall: 42, temp: 20.5, humidity: 66 },
    { month: "Feb", rainfall: 35, temp: 21.2, humidity: 61 },
    { month: "Mar", rainfall: 115, temp: 20.8, humidity: 73 },
    { month: "Apr", rainfall: 290, temp: 19.5, humidity: 83 },
    { month: "May", rainfall: 185, temp: 18.8, humidity: 79 },
    { month: "Jun", rainfall: 38, temp: 17.8, humidity: 63 },
    { month: "Jul", rainfall: 25, temp: 17.0, humidity: 59 },
    { month: "Aug", rainfall: 30, temp: 17.5, humidity: 61 },
    { month: "Sep", rainfall: 45, temp: 18.8, humidity: 64 },
    { month: "Oct", rainfall: 155, temp: 19.5, humidity: 76 },
    { month: "Nov", rainfall: 230, temp: 20.0, humidity: 81 },
    { month: "Dec", rainfall: 90, temp: 20.3, humidity: 71 },
  ],
  "Murang'a": [
    { month: "Jan", rainfall: 50, temp: 21.0, humidity: 67 },
    { month: "Feb", rainfall: 40, temp: 21.8, humidity: 62 },
    { month: "Mar", rainfall: 125, temp: 21.5, humidity: 74 },
    { month: "Apr", rainfall: 270, temp: 20.2, humidity: 84 },
    { month: "May", rainfall: 175, temp: 19.5, humidity: 79 },
    { month: "Jun", rainfall: 45, temp: 18.5, humidity: 63 },
    { month: "Jul", rainfall: 30, temp: 17.8, humidity: 59 },
    { month: "Aug", rainfall: 38, temp: 18.2, humidity: 61 },
    { month: "Sep", rainfall: 52, temp: 19.2, humidity: 65 },
    { month: "Oct", rainfall: 145, temp: 20.0, humidity: 76 },
    { month: "Nov", rainfall: 210, temp: 20.5, humidity: 80 },
    { month: "Dec", rainfall: 88, temp: 20.8, humidity: 70 },
  ],
  Kiambu: [
    { month: "Jan", rainfall: 55, temp: 20.0, humidity: 64 },
    { month: "Feb", rainfall: 45, temp: 20.8, humidity: 59 },
    { month: "Mar", rainfall: 110, temp: 20.5, humidity: 71 },
    { month: "Apr", rainfall: 250, temp: 19.2, humidity: 80 },
    { month: "May", rainfall: 160, temp: 18.5, humidity: 76 },
    { month: "Jun", rainfall: 48, temp: 17.2, humidity: 61 },
    { month: "Jul", rainfall: 32, temp: 16.5, humidity: 57 },
    { month: "Aug", rainfall: 40, temp: 17.0, humidity: 59 },
    { month: "Sep", rainfall: 55, temp: 18.2, humidity: 63 },
    { month: "Oct", rainfall: 140, temp: 19.0, humidity: 74 },
    { month: "Nov", rainfall: 200, temp: 19.5, humidity: 78 },
    { month: "Dec", rainfall: 82, temp: 19.8, humidity: 68 },
  ],
  Embu: [
    { month: "Jan", rainfall: 48, temp: 21.5, humidity: 66 },
    { month: "Feb", rainfall: 40, temp: 22.2, humidity: 61 },
    { month: "Mar", rainfall: 128, temp: 21.8, humidity: 74 },
    { month: "Apr", rainfall: 295, temp: 20.5, humidity: 84 },
    { month: "May", rainfall: 190, temp: 19.8, humidity: 80 },
    { month: "Jun", rainfall: 40, temp: 18.8, humidity: 63 },
    { month: "Jul", rainfall: 26, temp: 18.0, humidity: 59 },
    { month: "Aug", rainfall: 33, temp: 18.5, humidity: 61 },
    { month: "Sep", rainfall: 50, temp: 19.5, humidity: 65 },
    { month: "Oct", rainfall: 158, temp: 20.2, humidity: 77 },
    { month: "Nov", rainfall: 235, temp: 20.8, humidity: 82 },
    { month: "Dec", rainfall: 95, temp: 21.2, humidity: 71 },
  ],
  Meru: [
    { month: "Jan", rainfall: 40, temp: 20.8, humidity: 67 },
    { month: "Feb", rainfall: 33, temp: 21.5, humidity: 62 },
    { month: "Mar", rainfall: 135, temp: 21.2, humidity: 75 },
    { month: "Apr", rainfall: 305, temp: 19.8, humidity: 85 },
    { month: "May", rainfall: 195, temp: 19.0, humidity: 81 },
    { month: "Jun", rainfall: 36, temp: 18.0, humidity: 64 },
    { month: "Jul", rainfall: 24, temp: 17.2, humidity: 60 },
    { month: "Aug", rainfall: 30, temp: 17.8, humidity: 62 },
    { month: "Sep", rainfall: 44, temp: 18.5, humidity: 65 },
    { month: "Oct", rainfall: 162, temp: 19.5, humidity: 78 },
    { month: "Nov", rainfall: 245, temp: 20.2, humidity: 83 },
    { month: "Dec", rainfall: 98, temp: 20.5, humidity: 72 },
  ],
  Machakos: [
    { month: "Jan", rainfall: 30, temp: 23.5, humidity: 55 },
    { month: "Feb", rainfall: 25, temp: 24.2, humidity: 50 },
    { month: "Mar", rainfall: 85, temp: 23.8, humidity: 62 },
    { month: "Apr", rainfall: 200, temp: 22.5, humidity: 75 },
    { month: "May", rainfall: 120, temp: 21.8, humidity: 70 },
    { month: "Jun", rainfall: 25, temp: 20.5, humidity: 55 },
    { month: "Jul", rainfall: 15, temp: 19.8, humidity: 50 },
    { month: "Aug", rainfall: 20, temp: 20.2, humidity: 52 },
    { month: "Sep", rainfall: 30, temp: 21.5, humidity: 56 },
    { month: "Oct", rainfall: 100, temp: 22.2, humidity: 68 },
    { month: "Nov", rainfall: 160, temp: 22.8, humidity: 72 },
    { month: "Dec", rainfall: 60, temp: 23.2, humidity: 60 },
  ],
  Bungoma: [
    { month: "Jan", rainfall: 65, temp: 22.0, humidity: 70 },
    { month: "Feb", rainfall: 55, temp: 22.8, humidity: 65 },
    { month: "Mar", rainfall: 150, temp: 22.5, humidity: 78 },
    { month: "Apr", rainfall: 320, temp: 21.2, humidity: 88 },
    { month: "May", rainfall: 220, temp: 20.5, humidity: 84 },
    { month: "Jun", rainfall: 60, temp: 19.5, humidity: 68 },
    { month: "Jul", rainfall: 40, temp: 18.8, humidity: 64 },
    { month: "Aug", rainfall: 50, temp: 19.2, humidity: 66 },
    { month: "Sep", rainfall: 65, temp: 20.2, humidity: 70 },
    { month: "Oct", rainfall: 180, temp: 21.0, humidity: 80 },
    { month: "Nov", rainfall: 260, temp: 21.5, humidity: 85 },
    { month: "Dec", rainfall: 110, temp: 21.8, humidity: 74 },
  ],
};
